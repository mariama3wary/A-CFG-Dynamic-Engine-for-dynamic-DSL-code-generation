...
"""
    ...
    def create_interpolated_grid(self, center_lat, center_lon, scale_meters, grid_points=15):
        """
        ...
        points = []
        radius_lat = lat_degree * 2  # Make it 2x the scale for better coverage
        radius_lon = lon_degree * 2
        ...
        for ring in range(1, 4):  # 3 rings
            ...
            for i in range(num_points_in_ring):
                ...
                distance_factor = ring / 3.0  # Normalize to 0-1
