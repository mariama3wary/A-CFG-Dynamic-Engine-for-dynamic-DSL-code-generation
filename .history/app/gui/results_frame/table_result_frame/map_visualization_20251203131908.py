    ...
    def generate_folium_map(self):
        ...
        try:
            ...
            <div style="font-family: Arial; width: 300px; font-size: 13px;">
                ...
                <strong>{display_name}:</strong> {center_value:.4f if center_value else 'N/A'}
                </p>
                <hr>
            ...
            for display_name_all, gee_band_all in self.available_bands:
                ...
                popup_html += f"<p><strong>{display_name_all}:</strong> {value:.4f if value else 'N/A'}</p>"
            ...
            folium.Marker(
                ...
                tooltip=f"{display_name}: {center_value:.2f if center_value else 'N/A'}",
            ...
            <div style="position: fixed; top: 10px; right: 10px; width: 250px;
                ...
                <p><strong>Date:</strong> {self.current_date}</p>
                <p><strong>Center Value:</strong> {center_value:.4f if center_value else 'N/A'}</p>
