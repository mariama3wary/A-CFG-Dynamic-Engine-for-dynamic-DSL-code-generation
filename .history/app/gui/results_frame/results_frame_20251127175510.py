...
from app.gui.results_frame.table_result_frame import table_frame
from app.gui.results_frame import python_frame
...
class ResultsFrame(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.python_frame = python_frame(self)
        ...
        # Table frame
        self.table_frame = table_frame(self.bottom_frame)
